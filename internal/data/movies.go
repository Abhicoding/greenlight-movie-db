...
func ValidateMovie(v *validator.Validator, movie *Movie) {
	...
	v.Check(movie.Year >= 1888, "year", "must be greateer than 1888")
...
func (m MovieModel) Get(id uint64) (*Movie, error) {
	if id < 1 {
...
func (m MovieModel) Delete(id uint64) error {
	if id < 1 {
...
func (m MockMovieModel) Get(id uint64) (*Movie, error) {
	return nil, nil
}
...
func (m MockMovieModel) Delete(id uint64) error {
	return nil
}
